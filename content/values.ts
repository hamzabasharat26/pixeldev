export const values = [
  {
    ...
    body: "Working software on a real URL beats a beautiful plan every time. Something goes live early and improves in the open.",
  },
  {
    title: "Own the whole stack.",
    body: "Model, backend, infrastructure, deployment. No finger-pointing between vendors, because it's one team.",
  },
  {
  ...
  },
  {
    ...
    body: "Clean code, real documentation, full ownership on day one. You should never be trapped with us.",
  },
] as const;
