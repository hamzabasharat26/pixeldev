...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. We work with clients worldwide and are comfortable across time zones. Most communication happens over email, WhatsApp, and scheduled calls.",
  },
  {
    question: "Who owns the code?",
    answer:
      "You do. On final payment, you get full ownership of the codebase, the repository, and every design file. No lock-in and no license fees to us.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Usually, yes. We start with a short technical audit so we can tell you honestly whether it's better to extend what you have or rebuild the parts that are holding you back.",
  },
];
